...
function munk_customize_layout_content_color ( $config ) {
	...
	Kirki::add_field( 'munk', array(
		...
		array(
			'element'  => '.edit-post-visual-editor.editor-styles-wrapper p:not(.has-text-color), .edit-post-visual-editor.editor-styles-wrapper figcaption, .edit-post-visual-editor.editor-styles-wrapper ul, .edit-post-visual-editor.editor-styles-wrapper ul li, .edit-post-visual-editor.editor-styles-wrapper blockquote, .edit-post-visual-editor.editor-styles-wrapper blockquote p,.edit-post-visual-editor.editor-styles-wrapper span,.edit-post-visual-editor.editor-styles-wrapper ol,.edit-post-visual-editor.editor-styles-wrapper ol li, .edit-post-visual-editor.editor-styles-wrapper caption,.edit-post-visual-editor.editor-styles-wrapper table td,.edit-post-visual-editor.editor-styles-wrapper table tr td,.edit-post-visual-editor.editor-styles-wrapper form label, .edit-post-visual-editor.editor-styles-wrapper legend, .edit-post-visual-editor.editor-styles-wrapper address, .edit-post-visual-editor.editor-styles-wrapper pre',
			'property' => 'color',			
			'context'  => array( 'editor' ),
		),			
		),		
	...
	Kirki::add_field( 'munk', array(
		...
		'output' => array(
			array(
				'element'  => '.entry-card a:not(.has-text-color),.entry-content a:not(.has-text-color),.entry-content a:visited:not(.has-text-color),.entry-content a:focus,.entry-content a:active,.comment-list .reply a',
				'property' => 'color',
			),
			array(
